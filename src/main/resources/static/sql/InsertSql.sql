...
(2, '요구사항 수집', TRUE, 2),
(2, '데이터베이스 설계', TRUE, 1),
(2, '백엔드 기본 구조 구현', FALSE, 1),
(2, '프론트엔드 메인 페이지 디자인', FALSE, 2),
(2, 'OAuth 로그인 연동 (Google, GitHub)', FALSE, 1),
(2, 'AI 문제 풀이 기능 1차 버전 구현', FALSE, 1),
(2, '프로젝트 협업 기능 초안 개발', FALSE, 2),
(2, '테스트 서버 배포', FALSE, 3);

INSERT INTO project_diary (project_id, work_date, content) VALUES
(2, '2025-07-20', '요구사항을 정리하여 문서화 작업을 완료했습니다. 주요 기능 목록을 확정.'),
(2, '2025-07-25', '데이터베이스 기본 설계를 완료하고 ERD를 작성했습니다. 일부 테이블은 팀원 의견 반영 후 수정 예정.'),
(2, '2025-07-30', 'Spring Boot 기반의 백엔드 초기 구조를 세팅하고 공통 설정 코드를 작성했습니다.'),
(2, '2025-08-01', '프론트엔드 메인 페이지 시안을 제작하고, 디자인 툴로 공유하여 피드백을 받았습니다.'),
(2, '2025-08-03', 'Google OAuth 로그인 연동 테스트를 진행했으며, GitHub 연동은 에러 수정 후 재시도 예정.'),
(2, '2025-08-06', 'AI 문제 풀이 기능 1차 버전의 API 연동을 완료하고 간단한 테스트를 수행했습니다.'),
(2, '2025-08-09', '협업 기능(작업 다이어리, 체크리스트) 초안 UI를 구현했습니다.'),
(2, '2025-08-11', '테스트 서버에 첫 배포를 진행하고 주요 기능 동작 여부를 점검했습니다.');
