	...
	$('#checklistAddForm').on('submit', function(e) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				const buttonsHtml = `
				    <!-- 수정 버튼 -->
				    <button type="button" class="updateBtn btn btn-outline-primary btn-sm edit-checklist"
				            data-no="${data.checklistId}">
				        <i class="bi bi-pencil-square"></i>
				    </button>

				    <!-- 삭제 버튼 -->
				    <button type="button" class="deleteBtn btn btn-outline-danger btn-sm delete-checklist"
				            data-no="${data.checklistId}">
