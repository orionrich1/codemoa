...
function renderPagination(data) {
    ...
    if (startPage > pageGroup) {
        ...
        paginationHtml += `<li class="page-item"><a class="page-link" href="?pageNum=${prevPage}">Pre</a></li>`;
    }
    ...
    if (endPage < pageCount) {
        ...
        paginationHtml += `<li class="page-item"><a class="page-link" href="?pageNum=${nextPage}">Next</a></li>`;
    }
